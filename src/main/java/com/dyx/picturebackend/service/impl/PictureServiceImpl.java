...
import com.dyx.picturebackend.api.aliyunai.AliYunAiApi;
import com.dyx.picturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.dyx.picturebackend.mapper.PictureMapper;
import com.dyx.picturebackend.service.SpaceService;
import com.dyx.picturebackend.service.UserService;
import com.dyx.picturebackend.utils.ColorSimilarUtils;
...
// 空间权限校验
        ...
        if (pictureUploadRequestId!=null){
            Picture oldPicture = this.getById(pictureUploadRequestId);
            if (oldPicture==null) {
            ...
            if (spaceId==null) {
                ...
                if (ObjUtil.notEqual(spaceId,oldPicture.getSpaceId())) {
                    throw new BusinessException(ErrorCode.NOT_FOUND_ERROR,"空间id不一致");
                }
            }
...
// 开启事务
    ...
    public Page<PictureVO> getPictureVOPage(Page<Picture> picturePage,HttpServletRequest request) {
        ...
        Page<PictureVO> pictureVOPage1 = pictureVOPage.setRecords(pictureVOList);
        return pictureVOPage1;
    }
    @Override
...
// 批量重命名
    ...
    public void doPictureReview(PictureReviewRequest pictureReviewRequest, User loginUser) {
        //1校验参数
        if (ObjUtil.isEmpty(pictureReviewRequest)) {
    ...
    public void clearPictureFile(Picture oldPicture) {
        ...
        cosManger.deleteObject(oldPicture.getUrl());
        // 清理缩略图
        String thumbnailUrl = oldPicture.getThumbnailUrl();
        if (StrUtil.isNotBlank(thumbnailUrl)) {
            cosManger.deleteObject(thumbnailUrl);
        }
    }
